<template>
    <section
      ...
      class="flex items-center justify-center px-md rounded-2xl max-lg:mx-lg  w-full mb-12 mt-12"
    >
      <div class="flex items-center justify-around rounded-lg py-sm w-[1280px] max-sm:p-8 max-sm:flex-col bg-base-100 border-opacity-5 border-black">
        <div class="flex flex-col justify-start items-start">
          <NuxtImg
            src="/assets/sketch-logo-ai-h.png"
            :height="48"
            :width="247"
            :placeholder="[247, 48, 20, 5]"
            alt="Sketch Logo AI Logo"
            :style="{ width: '247px' }"
          />
          <p class=" font-semibold text-xl tracking-widest mt-4 mb-5 max-sm:mb-8">
            Made by Nuxt Starter AI
          </p>
          <a
            ...
            class="max-sm:hidden"
          >
            <div class="flex items-center gap-1 p-3 border-border-brand border-[2px] rounded-xl hover:bg-surface-brand-hover">
              <span class="text-border-brand font-medium">Visit Site</span>
              <svg
        ...
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="max-lg:w-[200px] w-[240px] max-sm:hidden"
            width="284"
            height="60"
            viewBox="0 0 284 60"
            fill="none"
        ...
        <div>
          <div
            ...
            class="no-scrollbar h-[300px] w-[300px] max-lg:w-[200px] max-sm:w-[100%] overflow-scroll"
          >
            <NuxtImg src="/assets/sample-app-showcase/sketch-logo-landing-small.png" :placeholder="[300, 300, 20, 5]" alt="Sketch Logo AI Landing Page" />
          </div>
        </div>
        <a
          href="https://sketchlogo.ai"
          target="_blank"
          rel="follow"
          class="max-sm:block hidden mt-8 w-full"
        >
          <div class="flex items-center justify-center gap-1 p-3 border-border-brand border-[2px] rounded-xl w-full hover:bg-surface-brand-hover">
            <span class="text-border-brand font-medium">Visit Site</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
...
import { ref } from "vue";
const sampleAppSSContainerRef = ref<HTMLDivElement>();
...
const scrollToPosition = ({
    ...
    const scrollingDiv = sampleAppSSContainerRef?.value as HTMLDivElement;
