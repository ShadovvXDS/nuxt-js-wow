<template>
  <section
    class="flex flex-col items-center p-xl bg-white border-[1px] rounded-2xl border-opacity-5 border-black w-[80%] mx-auto mb-12">
    <div class="flex flex-col items-center gap-2x w-full sm:w-[80%]">
      <div
      ...
      <h2 class=" text-5xl max-sm:text-lg text-center font-black text-[#1F2937]">
        No frustration when it comes to marketing your startup.
      </h2>
      <p class=" text-base font-normal mt-7 text-[#6B7280] text-center">
        Our SEO & Marketing guide is <strong>all in one</strong> to get you
        started.
      </p>
    </div>
    <div class="mt-xl  h-[350px] ">
      <div class="relative w-full h-full">
        <div class="absolute top-0 left-0 z-10 w-full h-full" :style="{
          background:
            'linear-gradient(180deg, rgba(255, 255, 255, 0.00) 0%, #FFF 75%)',
        }" />
        <div class="absolute w-[360px] sm:w-[405px] bottom-[15px] sm:bottom-[50px] left-1/2 translate-x-[-50%] z-10">
          <div class="flex flex-col items-center">
            ...
            <p class="text-[20px] mb-2 text-center font-semibold text-[#1F2937]">
              Access the SEO & Marketing guide
            </p>
            <p class="text-[16px] mb-2 text-center font-normal text-[#6B7280]">
              Learn how to get started with SEO & Marketing
            </p>
            <div class="mt-4">
              <ButtonCheckout variant="primary" :priceId="config.stripe.plans[1].priceId"
                :variantId="config.lemonsqueezy.plans[1].variantId" placement="landing_page"
                :mode="config.lemonsqueezy.plans[1].mode" text="Get Started" :withIcon="false" />
            </div>
          </div>
        </div>
        <div class="w-full overflow-hidden max-h-[300px]">
          <div class="hidden w-full sm:flex">
            <MarketingTable :marketingItems="exMarketingItems" :columns="['Website', 'Link Strength', 'Description']" />
          </div>
          <div class="w-full sm:hidden">
            <MarketingTable :marketingItems="exMarketingItemsSmall" :columns="['Website', 'Link Strength', 'Desc.']" />
          </div>
        </div>
      </div>
    </div>
...
const exMarketingItems = [
  {
    ...
    description: (
      <p>
        Trendy Startups is a platform where you can submit your startup to
        get feedback, upvotes, and backlinks. It's a great place to get
        feedback and upvotes, but the backlink is not worth the effort.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        There's an AI for that is a platform where you can submit your AI
        project to get feedback, upvotes, and backlinks. It's a great
        directory with a strong backlink.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        If you provide a free tier for developers, showcase it on
        freestuff.dev and receive a backlink with a Domain Authority of 22
      </p>
    ),
  },
];
const exMarketingItemsSmall = [
  {
    ...
    linkStrength: 48,
    description: (
      <p>Trendy Startups is a platform where ...</p>
    ),
  },
  {
    title: " Thereisanaiforthat",
